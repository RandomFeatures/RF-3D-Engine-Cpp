...
class cGraphics
{
  ...
  public:
	...
	BOOL SetLight(long Num, D3DLIGHT8 *Light);
...
class cTexture
{
  ...
  public:
    ...
    BOOL Load(cGraphics *Graphics, const char *Filename, DWORD Transparent = 0, D3DFORMAT Format = D3DFMT_UNKNOWN);
...
class cMesh
{
  private:
    ...
    void ParseXFileData(IDirectXFileData *pData, sFrame *ParentFrame, const char *TexturePath);
  ...
  public:
    ...
    BOOL    Load(cGraphics *Graphics, const char *Filename, const char *TexturePath = ".\\");
    BOOL    Free();
};
